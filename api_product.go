...
/*
ProductApiService Retrieve available DHL Express products for a one piece Shipment
 ...
 * @param optional nil or *ProductApiExpApiProductsOpts - Optional Parameters:
...
type ProductApiExpApiProductsOpts struct {
...
func (a *ProductApiService) ExpApiProducts(ctx context.Context, accountNumber string, originCountryCode string, originCityName string, destinationCountryCode string, destinationCityName string, weight float64, length float64, width float64, height float64, plannedShippingDate string, isCustomsDeclarable bool, unitOfMeasurement string, localVarOptionals *ProductApiExpApiProductsOpts) (SupermodelIoLogisticsExpressProducts, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue SupermodelIoLogisticsExpressProducts
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SupermodelIoLogisticsExpressProducts
