...
type SupermodelIoLogisticsExpressCreateShipmentResponseShipmentCharges struct {
	...
	ServiceBreakdown []SupermodelIoLogisticsExpressCreateShipmentResponseServiceBreakdown `json:"serviceBreakdown,omitempty"`
}
