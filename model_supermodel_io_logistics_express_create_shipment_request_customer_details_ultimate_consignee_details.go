...
type SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsUltimateConsigneeDetails struct {
	...
	BankDetails         *SupermodelIoLogisticsExpressRegistrationNumbers          `json:"bankDetails,omitempty"`
