...
type SupermodelIoLogisticsExpressUploadInvoiceDataRequestContent struct {
	// Here you can find all details related to export declaration
	ExportDeclaration []SupermodelIoLogisticsExpressExportDeclaration `json:"exportDeclaration"`
