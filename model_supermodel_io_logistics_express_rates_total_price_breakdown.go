...
type SupermodelIoLogisticsExpressRatesTotalPriceBreakdown struct {
	...
	PriceBreakdown []SupermodelIoLogisticsExpressRatesPriceBreakdown `json:"priceBreakdown,omitempty"`
}
