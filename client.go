...
// APIClient manages communication with the DHL Express APIs (MyDHL API) API v2.7.0
...
type APIClient struct {
	...
	IdentifierApi *IdentifierApiService

	InvoiceApi *InvoiceApiService

	PickupApi *PickupApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.IdentifierApi = (*IdentifierApiService)(&c.common)
	c.InvoiceApi = (*InvoiceApiService)(&c.common)
	c.PickupApi = (*PickupApiService)(&c.common)
