...
type SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsBuyerDetails struct {
	PostalAddress       *SupermodelIoLogisticsExpressAddressCreateShipmentRequest `json:"postalAddress"`
	ContactInformation  *SupermodelIoLogisticsExpressContactBuyer                 `json:"contactInformation"`
