...
/*
AddressApiService Validate DHL Express pickup/delivery capabilities at origin/destination
 ...
 * @param optional nil or *AddressApiExpApiAddressValidateOpts - Optional Parameters:
     * @param "PostalCode" (optional.String) -  Text specifying the postal code for an address. https://gs1.org/voc/postalCode
     * @param "CityName" (optional.String) -  Text specifying the city name
     * @param "CountyName" (optional.String) -  Text specifying the county name
     * @param "StrictValidation" (optional.Bool) -  If set to true service will return no records when exact valid match not found
...
type AddressApiExpApiAddressValidateOpts struct {
	PostalCode                    optional.String
	CityName                      optional.String
	CountyName                    optional.String
...
func (a *AddressApiService) ExpApiAddressValidate(ctx context.Context, type_ string, countryCode string, localVarOptionals *AddressApiExpApiAddressValidateOpts) (SupermodelIoLogisticsExpressAddressValidateResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue SupermodelIoLogisticsExpressAddressValidateResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/address-validate"
	...
	if localVarOptionals != nil && localVarOptionals.CityName.IsSet() {
		localVarQueryParams.Add("cityName", parameterToString(localVarOptionals.CityName.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.CountyName.IsSet() {
		localVarQueryParams.Add("countyName", parameterToString(localVarOptionals.CountyName.Value(), ""))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SupermodelIoLogisticsExpressAddressValidateResponse
