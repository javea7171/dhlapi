...
type SupermodelIoLogisticsExpressUpdatePickupRequest struct {
	...
	OriginalShipperAccountNumber string `json:"originalShipperAccountNumber"`
	...
	ShipmentDetails []SupermodelIoLogisticsExpressUpdatePickupRequestShipmentDetails `json:"shipmentDetails,omitempty"`
}
